...
public class EducationsController(IEducationService service) : ControllerBase
{
    [HttpGet]
    ...
    [HttpGet("{id:guid}")]
    public async Task<ActionResult<EducationDto>> GetById(Guid id, CancellationToken cancellationToken)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<EducationDto>> Create(CreateEducationRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, UpdateEducationRequest request, CancellationToken cancellationToken)
    {
